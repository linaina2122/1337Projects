...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/20 19:05:55 by hcharef           #+#    #+#             */
/*   Updated: 2022/11/20 19:05:58 by hcharef          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	my_export(char ***env, char **new_var)
{
	...
	else
	{
		while (new_var[++j])
		{
			...
			{
				g_exit_code = 1;
				printf_error("minishell : export: `",
					new_var[j], "': not a valid identifier\n");
			}
